...
export default function AboutUsPage() {
  ...
  return (
    <div>
      ...
      />
      <Parallax image="/img/busola-media.jpg" filter="dark" small>
        <div className={classes.container}>
          <GridContainer justify="center">
            ...
            >
              ...
              <h4>
                În perioada <strong>martie–septembrie 2025</strong>,<br />
                <strong>Asociația IDEI</strong> a derulat proiectul:
                <br />
                <strong
                  style={{
                    fontSize: "1.4rem",
                ...
                >
                  Busola Media pentru Tineri <br />– Orientare în Lumea Digitală
                  și Dezvoltarea Competențelor Critice –
                </strong>
              </h4>
            </GridItem>
          </GridContainer>
        ...
        content={
          <div>
            ...
            <div className={classes.right}>
              &copy; {1900 + new Date().getYear()}&nbsp; Asociatia IDEI -
